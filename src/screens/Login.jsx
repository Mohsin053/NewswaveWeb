...
const Login = () => {
  ...
  const [isContent1Visible, setContent1Visible] = useState(true);
    ...
    if (isContent1Visible) {
        ...
        <div className="order-2 flex w-full flex-col items-center justify-center bg-sidebar py-[15px] sm:w-[50%] md:order-2 md:w-[50%] md:shadow-md ">
          ...
          <div className="mt-[18px] flex w-[60%]  cursor-pointer select-none flex-row items-center gap-x-2 ">
            <div
              ...
              className="h-[17px] w-[17px] rounded-[100px] border-[2px] border-[#FF8216]"
            >
              {checked && (
            ...
            <div>
              <p className="text-[#48525B]">
                ...
                and <span className="text-[#FF8216]">Disclaimer</span>{" "}
              </p>
            </div>
          </div>
      ...
      return (
        <div className="order-2 flex w-full flex-col items-center justify-center bg-sidebar py-[15px] sm:w-[50%] md:order-2 md:w-[50%] md:shadow-md ">
          ...
          <p className="mt-[5px] text-[20px] font-semibold text-[black]">
            Sign in to <span className="text-[#FF8216]">NewsWave</span>
          </p>
          ...
          <div className="mt-[18px] flex w-[60%]  cursor-pointer select-none flex-row items-center gap-x-2 ">
            ...
            <div className="ml-auto" onClick={() => setChecked(!checked)}>
              <p className="font-semibold text-[#FF8216]">Forgot Password</p>
            </div>
          </div>
  ...
  return (
    <div className="flex h-screen w-full flex-row flex-wrap">
      ...
      <dialog id="my_modal_3" className="modal ">
        <div className="modal-box h-[400px] w-[400px] bg-white">
          <form method="dialog">
          ...
          <div>
            ...
            <p className="pt-4 text-[black]">
              ...
              <span className="font-semibold text-[#FF8216]">{email}</span>
            </p>
            <p className="pt-4 text-[black]">
            ...
            <div className="mt-[20px] flex w-full  justify-center ">
              ...
              <button className="text-button ml-[5px] text-[15px] font-semibold text-[#FF8216] hover:text-blue-700 focus:outline-none">
                Resend
              </button>
            </div>
          </div>
